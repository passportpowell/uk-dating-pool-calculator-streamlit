...
# Import from src package modules
...
with st.expander("Files Used (Dating Pool Calculator)", expanded=False):
    st.markdown(
        """
- data/raw/censusbasedstatisticsuk2021.xlsx (Table_01, UK population by age and sex)
...
- data/processed/ethnicity_distribution.csv (ethnicity shares)
- data/processed/self_employed_income_distribution_male.csv and data/processed/self_employed_income_distribution_female.csv (self-employed income)
        """
    )
